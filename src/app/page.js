...
const page = () => {
  ...
  return (
    <div className="transition-colors duration-1000 dark:text-white dark:bg-black  font-poppins text-5xl  ">
      <CarouselComponent />

      <div className="flex flex-wrap justify-center mx-auto border">
        {foodData.map((data) => (
          <Card food={data} />
        ))}
      </div>
