      ...
      <div className="w-80 rounded-lg bg-white overflow-hidden dark:bg-black border-gradient">
        ...
        <div className="flex p-4 font-bold  justify-between">
          <button
            ...
            className="border text-[26px] cursor-pointer dark:border-gray-400 border-gray-900 rounded p-2 hover:bg-gradient-to-r from-indigo-700 via-violet-700 to-orange-700  hover:text-gray-100 "
          >
            Add to cart
          </button>
